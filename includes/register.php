<?php
	...
	if($_SESSION['reg_error'] == 'true' and (isset($_SESSION['password_mismatch']) or isset($_SESSION['format_incorrect']) or isset($_SESSION['email_exists']) or isset($_SESSION['field_blank']))){
	...
	//echo "<div style=''";
	echo "<center>";
	echo "<div  style='width:auto;margin-left:auto;margin-right:35%'>";
