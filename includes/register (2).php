<?php
	...
	echo "</ul></div>";
	echo "<form enctype='multipart/form-data' style='color:#12146B;font-weight:bold;margin:5px;padding:5px;border:0px black solid;margin-right:150px' action='process_registration.php' method='POST'>";
