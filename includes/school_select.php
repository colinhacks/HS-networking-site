...
unset($_SESSION['upload_error2']);
	...
	$schools = getSpecificOrderedRows("school","region","europe","school_name","asc");
	...
	echo "<input type='submit' value='Submit!' action='process_school_select.php' style='text-align:right;border:2px outset #12146B;'/>";
	
	
	echo "</form>";
	echo "<br/><div style='color:#12146B;text-align:center;font-style:bold;'>Don't see your school?<br/>";
	echo "<a class='infobar' href='generic.php?job=create_school' ><span style='color:#12146B;font-variant:small-caps;padding:1px;border:2px outset #12146B'>create the page</span></a></div>";
